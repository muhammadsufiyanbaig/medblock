...
const Record = () => {
  ...
  const submittedRecords = useSelector((state) => state.submittedRecords);
      ...
      {account ? (
        <div className="overflow-x-auto">
          <table className="min-w-full bg-white rounded-lg shadow-md">
            ...
            <tbody>
              {submittedRecords &&
                submittedRecords.map((data, index) => {
                  return (
                    <tr key={data.recordId} className="border-b hover:bg-gray-100">
